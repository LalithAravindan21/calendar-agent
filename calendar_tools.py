...
client_secret = 'client-secret1.json'
...
def insert_calendar_event(calendar_id, event_details):
    if isinstance(event_details, str):
        event_details = json.loads(event_details)  # ✅ convert JSON string to dict

    print("Inserting event with details:", event_details)  # for verification
